    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/edoardesd/smartparkingtemplate/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/edoardesd/smartparkingtemplate.git")
                    developerConnection.set("scm:git:ssh://github.com/edoardesd/smartparkingtemplate.git")
                    url.set("https://github.com/edoardesd/smartparkingtemplate/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/edoardesd/smartparkingtemplate/issues")
                }
            }
        }
    }
